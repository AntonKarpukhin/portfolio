export const dataLanguage = {
  navigate: {
    ru: ['Главная', 'Обо мне', 'Навыки', "Портфолио", 'Контакты'],
    en: ['Home', 'About me', 'Skills', 'Portfolio', 'Contacts']
  },
  name: {
    ru: ['Антон Карпухин', 'Frontend developer, Москва'],
    en: ['Anton Karpukhin', 'Frontend developer, Moscow']
  },
  about: {
    ru: [
      'Обо мне',
      'Привет, я Антон — Frontend developer из Москвы. Интересуюсь Web разработкой и всем, что с ней связано.',
      'Я закончил курс «Фулстек - разработчик» в Яндекс Практикуме. Сейчас разрабатываю корпоративную платформу для своей небольшой компании.',
      'Готов реализовывать интересные проекты с замечательными людьми.'
    ],
    en: [
      'About me',
      `Hello, I'm Anton - Frontend developer from Moscow. I am interested in Web development and everything connected with it.`,
      'I completed the course “Full Stack Developer” course at Yandex Practicum. Currently I am developing an enterprise platform for my small company.',
      'Ready to implement interesting projects with wonderful people.'
    ]
  },
  skills: {
    ru: ['Навыки', 'Я работаю c такими программами как'],
    en: ['Skills', 'I work with programs such as']
  },
  portfolio: {
    ru: ['Портфолио', 'Новые проекты', 'Старые проекты'],
    en: ['Portfolio', 'New projects', 'Old projects']
  },
  footer: {
    ru: ['Контакты', 'Хотите узнать больше или просто пообщаться? Пишите!', 'Сообщение'],
    en: ['Contacts', 'Want to know more or just chat? You are welcome!', 'Send message']
  }
}

export const sliderNew = [
  {
    img: 'https://i.ibb.co/C6qHrP0/Screenshot-6.jpg',
    name: 'ProCharity',
    link: 'https://procharity.ru/about_project/',
    git: 'https://procharity.ru/about_project/'
  },
]

export const sliderOld = [
  {
    img: 'https://i.ibb.co/qmffBHP/Screenshot-3.jpg',
    name: 'Cosinuts',
    link: 'https://shop-cosinuts.vercel.app/',
    git: 'https://github.com/AntonKarpukhin/cosinuts'
  },
  {
    img: 'https://i.ibb.co/HB073Wx/Screenshot-5.jpg',
    name: 'Tony-movie',
    link: 'https://tony-movie-project.vercel.app/genre/thriller',
    git: 'https://github.com/AntonKarpukhin/Tony-Movie-Project'
  },
]
...
export const skills = [
  ...
  },
  {
    ...
    `,
    name: 'javaScript',
    stars: ['star', 'star', 'star', 'star', 'grade']
  },
  {
    src: `<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
    ...
    `,
    name: 'typeScript',
    stars: ['star', 'star', 'star', 'grade', 'grade']
  },
  {
    src: `<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
  ...
  },
  {
    ...
    `,
    name: 'node js',
    stars: ['star', 'star', 'grade', 'grade', 'grade']
  },
  {
    src: `<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
